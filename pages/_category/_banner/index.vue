    ...
    methods: {
        ...
        getSizeScale() {
            ...
            setTimeout(() => {
                ...
                // if (this.ratioSize.width / this.ratioSize.height - containerWidth / containerHeight === 0) {
                //     this.ratioSize.height = containerHeight;
                //     this.ratioSize.width = containerWidth;
                // }

                // if (this.ratioSize.width > this.ratioSize.height && this.ratioSize.width < containerWidth) {
                //     this.sizeChange = containerWidth / this.ratioSize.width;
                // }
                // else if (this.ratioSize.width < this.ratioSize.height && this.ratioSize.height < containerHeight) {
